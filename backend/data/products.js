const products = [
  ...
  },
  {
    ...
    description:
      'iPhone 14 Pro Max. Capture incredible detail with a 48MP Main camera. Experience iPhone in a whole new way with Dynamic Island and Always-On display. And get peace of mind with a vital new safety feature. ',
    brand: 'Apple',
    category: 'Electronics',
    price: 1999.99,
    countInStock: 8,
...

  {
    ...
    description:
      '2022 Apple MacBook Air laptop with M2 chip: 13.6-inch Liquid Retina display, 8GB RAM, 256GB SSD storage, backlit keyboard, 1080p FaceTime HD camera. Works with iPhone and iPad',
    brand: 'Apple',
    category: 'Electronics',
    price: 1449.99,
    countInStock: 17,
